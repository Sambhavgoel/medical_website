...
import doctors from '../assets/physio.jpg';
    ...
    <>
      ...
      >
        ...
        <div className="flex-1 flex flex-col justify-center p-8 text-center md:text-left">
          ...
          Orthologists specialize in the study and treatment of bone, joint, and musculoskeletal disorders. They diagnose, treat injuries, and manage conditions like arthritis, fractures, and spinal problems to improve mobility and quality of life.
          </p>
