...
import doctors from '../assets/jonathan-borba-W9YEY6G8LVM-unsplash.jpg';
    ...
    <>
      ...
      >
        ...
        <div className="flex-1 flex flex-col justify-center p-8 text-center md:text-left">
          ...
          Dentists specialize in oral health, diagnosing and treating issues related to teeth, gums, and the mouth. They perform cleanings, fillings, extractions, and provide preventive care to maintain overall dental health.
          </p>
