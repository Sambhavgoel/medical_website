...
import doctors from '../assets/pediatric.jpg';
    ...
    <>
      ...
      >
        ...
        <div className="flex-1 flex flex-col justify-center p-8 text-center md:text-left">
          ...
          Pediatrics is a branch of medicine focused on the health and medical care of infants, children, and adolescents. Pediatricians diagnose, treat, and prevent childhood diseases, ensuring healthy growth and development.
          </p>
