...
import doctors from '../assets/Bullet-3.jpg';
    ...
    <>
      ...
      >
        ...
        <div className="flex-1 flex flex-col justify-center p-8 text-center md:text-left">
          ...
          Gynecologists specialize in women's reproductive health, diagnosing and treating conditions related to the uterus, ovaries, and other reproductive organs. They also provide prenatal care, family planning, and manage menopause-related issues.
          </p>
