...
import doctors from '../assets/kenny-eliason-MEbT27ZrtdE-unsplash.jpg';
import AppointHeader from './AppointHeader';
import DoctorList from '../components/DoctorList';

const HeartDiseasesPage = () => {
  const handleScroll = () => {
      ...
      >
        ...
        <div className="flex-1 flex flex-col justify-center p-8 text-center md:text-left">
          ...
          <p className="text-lg md:text-2xl text-[#54473F] leading-relaxed mb-6 font-handwriting">
            ...
            including coronary heart disease, which can cause heart attacks, stroke, heart failure, and peripheral
            artery disease.
          </p>
...
export default HeartDiseasesPage;
